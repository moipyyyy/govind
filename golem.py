...
TOKEN = '7703225179:AAG4BoY99pERBLLwfh_VDWg8jktZhwzOyUc'
...
def is_user_admin(5786411100,-1002475823545):
    try:
        return bot.get_chat_member(-1002475823545,5786411100).status in ['administrator', 'creator']
    except:
        return False
